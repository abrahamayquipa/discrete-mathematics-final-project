...
>>>>>>> 0a6ec2c70b508208755a647900c1b86c2c305b6b
	...
	/*Cancùn 					*/		{ Ciudad("Cancún", "Belice", 0),				Ciudad("Cancún", "Bogota", 1),					Ciudad("Cancún", "Cali", 0),				Ciudad("Cancún", "Cancún", 0),					Ciudad("Cancún", "Caracas", 0),					Ciudad("Cancún", "Ciudad de Guatemala", 0),					Ciudad("Cancún", "Ciudad de México", 0),				Ciudad("Cancún", "Punta Cana", 0),					Ciudad("Cancún", "Ciudad de Panama", 0),				 Ciudad("Cancún", "Flores", 0),					Ciudad("Cancún", "Guayaquil", 0),					Ciudad("Cancún", "La Ceiba", 0),					Ciudad("Cancún", "La Habana", 0),					Ciudad("Cancún", "Libera", 0),					Ciudad("Cancún", "Lima", 0),				Ciudad("Cancún", "Managua", 0),					Ciudad("Cancún", "Medellin", 0),				Ciudad("Cancún", "Quito", 0),					Ciudad("Cancún", "Roatán", 0),					Ciudad("Cancún", "San José de Costa Rica", 0),                  Ciudad("Cancún", "San Juan", 0),					Ciudad("Cancún", "San Pedro de Sula", 0),					Ciudad("Cancún", "San Salvador", 1),					Ciudad("Cancún", "San Domingo", 0),					Ciudad("Cancún", "Tegucigalpa", 0),					},
	/*Caracas 					*/		{ Ciudad("Caracas", "Belice", 0),				Ciudad("Caracas", "Bogota", 0),					Ciudad("Caracas", "Cali", 0),				Ciudad("Caracas", "Cancún", 0),					Ciudad("Caracas", "Caracas", 0),				Ciudad("Caracas", "Ciudad de Guatemala", 0),				Ciudad("Caracas", "Ciudad de México", 0),				Ciudad("Caracas", "Punta Cana", 0),					Ciudad("Caracas", "Ciudad de Panama", 0),                Ciudad("Caracas", "Flores", 0),				Ciudad("Caracas", "Guayaquil", 0),					Ciudad("Caracas", "La Ceiba", 0),					Ciudad("Caracas", "La Habana", 0),					Ciudad("Caracas", "Libera", 0),					Ciudad("Caracas", "Lima", 0),				Ciudad("Caracas", "Managua", 0),				Ciudad("Caracas", "Medellin", 0),				Ciudad("Caracas", "Quito", 0),					Ciudad("Caracas", "Roatán", 0),					Ciudad("Caracas", "San José de Costa Rica", 1),                 Ciudad("Caracas", "San Juan", 0),					Ciudad("Caracas", "San Pedro de Sula", 0),					Ciudad("Caracas", "San Salvador", 0),					Ciudad("Caracas", "San Domingo", 0),				Ciudad("Caracas", "Tegucigalpa", 0),				},
	/*Ciudad de Guatemala 		*/		{ Ciudad("Ciudad de Guatemala", "Belice", 0),   Ciudad("Ciudad de Guatemala", "Bogota", 1),		Ciudad("Ciudad de Guatemala", "Cali", 0),   Ciudad("Ciudad de Guatemala", "Cancún", 0),     Ciudad("Ciudad de Guatemala", "Caracas", 0),	Ciudad("Ciudad de Guatemala", "Ciudad de Guatemala", 0),	Ciudad("Ciudad de Guatemala", "Ciudad de México", 0),	Ciudad("Ciudad de Guatemala", "Punta Cana", 0),		Ciudad("Ciudad de Guatemala", "Ciudad de Panama", 0),    Ciudad("Ciudad de Guatemala", "Flores", 1),    Ciudad("Ciudad de Guatemala", "Guayaquil", 0),		Ciudad("Ciudad de Guatemala", "La Ceiba", 0),       Ciudad("Ciudad de Guatemala", "La Habana", 0),      Ciudad("Ciudad de Guatemala", "Libera", 0),     Ciudad("Ciudad de Guatemala", "Lima", 0),   Ciudad("Ciudad de Guatemala", "Managua", 0),    Ciudad("Ciudad de Guatemala", "Medellin", 0),   Ciudad("Ciudad de Guatemala", "Quito", 0),      Ciudad("Ciudad de Guatemala", "Roatán", 0),     Ciudad("Ciudad de Guatemala", "San José de Costa Rica", 1),     Ciudad("Ciudad de Guatemala", "San Juan", 0),		Ciudad("Ciudad de Guatemala", "San Pedro de Sula", 1),      Ciudad("Ciudad de Guatemala", "San Salvador", 1),       Ciudad("Ciudad de Guatemala", "San Domingo", 0),    Ciudad("Ciudad de Guatemala", "Tegucigalpa", 1),    },
	/*Ciudad de Mèxico 			*/		{ Ciudad("Ciudad de México", "Belice", 0),      Ciudad("Ciudad de México", "Bogota", 1),		Ciudad("Ciudad de México", "Cali", 0),      Ciudad("Ciudad de México", "Cancún", 0),        Ciudad("Ciudad de México", "Caracas", 0),		Ciudad("Ciudad de México", "Ciudad de Guatemala", 0),		Ciudad("Ciudad de México", "Ciudad de México", 0),		Ciudad("Ciudad de México", "Punta Cana", 0),		Ciudad("Ciudad de México", "Ciudad de Panama", 0),       Ciudad("Ciudad de México", "Flores", 0),       Ciudad("Ciudad de México", "Guayaquil", 0),			Ciudad("Ciudad de México", "La Ceiba", 0),          Ciudad("Ciudad de México", "La Habana", 0),         Ciudad("Ciudad de México", "Libera", 0),        Ciudad("Ciudad de México", "Lima", 1),      Ciudad("Ciudad de México", "Managua", 0),       Ciudad("Ciudad de México", "Medellin", 0),      Ciudad("Ciudad de México", "Quito", 0),			Ciudad("Ciudad de México", "Roatán", 0),        Ciudad("Ciudad de México", "San José de Costa Rica", 1),        Ciudad("Ciudad de México", "San Juan", 0),			Ciudad("Ciudad de México", "San Pedro de Sula", 0),         Ciudad("Ciudad de México", "San Salvador", 1),          Ciudad("Ciudad de México", "San Domingo", 0),       Ciudad("Ciudad de México", "Tegucigalpa", 0),		},
	/*Ciudad de Panama 			*/		{ Ciudad("Ciudad de Panama", "Belice", 0),      Ciudad("Ciudad de Panama", "Bogota", 1),		Ciudad("Ciudad de Panama", "Cali", 0),      Ciudad("Ciudad de Panama", "Cancún", 0),	    Ciudad("Ciudad de Panama", "Caracas", 0),		Ciudad("Ciudad de Panama", "Ciudad de Guatemala", 0),		Ciudad("Ciudad de Panama", "Ciudad de México", 0),		Ciudad("Ciudad de Panama", "Punta Cana", 0),		Ciudad("Ciudad de Panama", "Ciudad de Panama", 0),       Ciudad("Ciudad de Panama", "Flores", 0),       Ciudad("Ciudad de Panama", "Guayaquil", 0),			Ciudad("Ciudad de Panama", "La Ceiba", 0),          Ciudad("Ciudad de Panama", "La Habana", 0),         Ciudad("Ciudad de Panama", "Libera", 0),        Ciudad("Ciudad de Panama", "Lima", 0),      Ciudad("Ciudad de Panama", "Managua", 0),       Ciudad("Ciudad de Panama", "Medellin", 0),      Ciudad("Ciudad de Panama", "Quito", 0),			Ciudad("Ciudad de Panama", "Roatán", 0),        Ciudad("Ciudad de Panama", "San José de Costa Rica", 1),        Ciudad("Ciudad de Panama", "San Juan", 0),			Ciudad("Ciudad de Panama", "San Pedro de Sula", 0),         Ciudad("Ciudad de Panama", "San Salvador", 1),          Ciudad("Ciudad de Panama", "San Domingo", 0),       Ciudad("Ciudad de Panama", "Tegucigalpa", 0),		},
	/*Flores 					*/		{ Ciudad("Flores", "Belice", 0),				Ciudad("Flores", "Bogota", 0),					Ciudad("Flores", "Cali", 0),				Ciudad("Flores", "Cancún", 0),					Ciudad("Flores", "Caracas", 0),					Ciudad("Flores", "Ciudad de Guatemala", 1),					Ciudad("Flores", "Ciudad de México", 0),				Ciudad("Flores", "Punta Cana", 0),					Ciudad("Flores", "Ciudad de Panama", 0),                 Ciudad("Flores", "Flores", 0),					Ciudad("Flores", "Guayaquil", 0),					Ciudad("Flores", "La Ceiba", 0),					Ciudad("Flores", "La Habana", 0),					Ciudad("Flores", "Libera", 0),					Ciudad("Flores", "Lima", 0),				Ciudad("Flores", "Managua", 0),					Ciudad("Flores", "Medellin", 0),				Ciudad("Flores", "Quito", 0),					Ciudad("Flores", "Roatán", 0),					Ciudad("Flores", "San José de Costa Rica", 0),                  Ciudad("Flores", "San Juan", 0),					Ciudad("Flores", "San Pedro de Sula", 0),					Ciudad("Flores", "San Salvador", 0),					Ciudad("Flores", "San Domingo", 0),					Ciudad("Flores", "Tegucigalpa", 0),					},
	/*Guayaquil 				*/		{ Ciudad("Guayaquil", "Belice", 0),				Ciudad("Guayaquil", "Bogota", 0),				Ciudad("Guayaquil", "Cali", 0),				Ciudad("Guayaquil", "Cancún", 0),				Ciudad("Guayaquil", "Caracas", 0),				Ciudad("Guayaquil", "Ciudad de Guatemala", 0),				Ciudad("Guayaquil", "Ciudad de México", 0),				Ciudad("Guayaquil", "Punta Cana", 0),				Ciudad("Guayaquil", "Ciudad de Panama", 0),              Ciudad("Guayaquil", "Flores", 0),				Ciudad("Guayaquil", "Guayaquil", 0),				Ciudad("Guayaquil", "La Ceiba", 0),					Ciudad("Guayaquil", "La Habana", 0),				Ciudad("Guayaquil", "Libera", 0),				Ciudad("Guayaquil", "Lima", 1),				Ciudad("Guayaquil", "Managua", 0),				Ciudad("Guayaquil", "Medellin", 0),				Ciudad("Guayaquil", "Quito", 0),				Ciudad("Guayaquil", "Roatán", 0),               Ciudad("Guayaquil", "San José de Costa Rica", 0),               Ciudad("Guayaquil", "San Juan", 0),					Ciudad("Guayaquil", "San Pedro de Sula", 0),				Ciudad("Guayaquil", "San Salvador", 1),					Ciudad("Guayaquil", "San Domingo", 0),              Ciudad("Guayaquil", "Tegucigalpa", 0),				},
	/*La Ceiba 					*/		{ Ciudad("La Ceiba", "Belice", 0),				Ciudad("La Ceiba", "Bogota", 0),				Ciudad("La Ceiba", "Cali", 0),				Ciudad("La Ceiba", "Cancún", 0),				Ciudad("La Ceiba", "Caracas", 0),				Ciudad("La Ceiba", "Ciudad de Guatemala", 0),				Ciudad("La Ceiba", "Ciudad de México", 0),				Ciudad("La Ceiba", "Punta Cana", 0),				Ciudad("La Ceiba", "Ciudad de Panama", 0),               Ciudad("La Ceiba", "Flores", 0),				Ciudad("La Ceiba", "Guayaquil", 0),					Ciudad("La Ceiba", "La Ceiba", 0),					Ciudad("La Ceiba", "La Habana", 0),					Ciudad("La Ceiba", "Libera", 0),				Ciudad("La Ceiba", "Lima", 0),				Ciudad("La Ceiba", "Managua", 0),				Ciudad("La Ceiba", "Medellin", 0),				Ciudad("La Ceiba", "Quito", 0),					Ciudad("La Ceiba", "Roatán", 0),                Ciudad("La Ceiba", "San José de Costa Rica", 0),                Ciudad("La Ceiba", "San Juan", 0),					Ciudad("La Ceiba", "San Pedro de Sula", 0),					Ciudad("La Ceiba", "San Salvador", 0),					Ciudad("La Ceiba", "San Domingo", 0),				Ciudad("La Ceiba", "Tegucigalpa", 1),				},
	/*La Habana					*/		{ Ciudad("La Habana", "Belice", 0),				Ciudad("La Habana", "Bogota", 0),				Ciudad("La Habana", "Cali", 0),				Ciudad("La Habana", "Cancún", 0),				Ciudad("La Habana", "Caracas", 0),				Ciudad("La Habana", "Ciudad de Guatemala", 0),				Ciudad("La Habana", "Ciudad de México", 0),				Ciudad("La Habana", "Punta Cana", 0),				Ciudad("La Habana", "Ciudad de Panama", 0),              Ciudad("La Habana", "Flores", 0),				Ciudad("La Habana", "Guayaquil", 0),				Ciudad("La Habana", "La Ceiba", 0),					Ciudad("La Habana", "La Habana", 0),				Ciudad("La Habana", "Libera", 0),				Ciudad("La Habana", "Lima", 0),				Ciudad("La Habana", "Managua", 0),				Ciudad("La Habana", "Medellin", 0),				Ciudad("La Habana", "Quito", 0),				Ciudad("La Habana", "Roatán", 0),               Ciudad("La Habana", "San José de Costa Rica", 0),               Ciudad("La Habana", "San Juan", 0),					Ciudad("La Habana", "San Pedro de Sula", 0),				Ciudad("La Habana", "San Salvador", 1),					Ciudad("La Habana", "San Domingo", 0),              Ciudad("La Habana", "Tegucigalpa", 0),				},
	/*Liberia 					*/		{ Ciudad("Liberia", "Belice", 0),				Ciudad("Liberia", "Bogota", 0),					Ciudad("Liberia", "Cali", 0),				Ciudad("Liberia", "Cancún", 0),					Ciudad("Liberia", "Caracas", 0),				Ciudad("Liberia", "Ciudad de Guatemala", 0),				Ciudad("Liberia", "Ciudad de México", 0),				Ciudad("Liberia", "Punta Cana", 0),					Ciudad("Liberia", "Ciudad de Panama", 0),                Ciudad("Liberia", "Flores", 0),				Ciudad("Liberia", "Guayaquil", 0),					Ciudad("Liberia", "La Ceiba", 0),					Ciudad("Liberia", "La Habana", 0),					Ciudad("Liberia", "Libera", 0),					Ciudad("Liberia", "Lima", 0),				Ciudad("Liberia", "Managua", 0),				Ciudad("Liberia", "Medellin", 0),				Ciudad("Liberia", "Quito", 0),					Ciudad("Liberia", "Roatán", 0),					Ciudad("Liberia", "San José de Costa Rica", 0),                 Ciudad("Liberia", "San Juan", 0),					Ciudad("Liberia", "San Pedro de Sula", 0),					Ciudad("Liberia", "San Salvador", 1),					Ciudad("Liberia", "San Domingo", 0),				Ciudad("Liberia", "Tegucigalpa", 0),				},
	/*Lima						*/		{ Ciudad("Lima", "Belice", 0),					Ciudad("Lima", "Bogota", 0),					Ciudad("Lima", "Cali", 0),					Ciudad("Lima", "Cancún", 0),					Ciudad("Lima", "Caracas", 0),					Ciudad("Lima", "Ciudad de Guatemala", 0),					Ciudad("Lima", "Ciudad de México", 1),					Ciudad("Lima", "Punta Cana", 0),					Ciudad("Lima", "Ciudad de Panama", 0),                   Ciudad("Lima", "Flores", 0),					Ciudad("Lima", "Guayaquil", 1),						Ciudad("Lima", "La Ceiba", 0),						Ciudad("Lima", "La Habana", 0),						Ciudad("Lima", "Libera", 0),					Ciudad("Lima", "Lima", 0),					Ciudad("Lima", "Managua", 0),					Ciudad("Lima", "Medellin", 0),					Ciudad("Lima", "Quito", 1),						Ciudad("Lima", "Roatán", 0),					Ciudad("Lima", "San José de Costa Rica", 1),					Ciudad("Lima", "San Juan", 0),						Ciudad("Lima", "San Pedro de Sula", 0),						Ciudad("Lima", "San Salvador", 1),						Ciudad("Lima", "San Domingo", 1),					Ciudad("Lima", "Tegucigalpa", 0),					},
	/*Managua					*/		{ Ciudad("Managua", "Belice", 0),				Ciudad("Managua", "Bogota", 0),					Ciudad("Managua", "Cali", 0),				Ciudad("Managua", "Cancún", 0),					Ciudad("Managua", "Caracas", 0),				Ciudad("Managua", "Ciudad de Guatemala", 0),				Ciudad("Managua", "Ciudad de México", 0),				Ciudad("Managua", "Punta Cana", 0),					Ciudad("Managua", "Ciudad de Panama", 1),                Ciudad("Managua", "Flores", 0),				Ciudad("Managua", "Guayaquil", 0),					Ciudad("Managua", "La Ceiba", 0),					Ciudad("Managua", "La Habana", 0),					Ciudad("Managua", "Libera", 0),				    Ciudad("Managua", "Lima", 0),				Ciudad("Managua", "Managua", 0),				Ciudad("Managua", "Medellin", 0),				Ciudad("Managua", "Quito", 0),					Ciudad("Managua", "Roatán", 0),					Ciudad("Managua", "San José de Costa Rica", 1),                 Ciudad("Managua", "San Juan", 0),					Ciudad("Managua", "San Pedro de Sula", 0),					Ciudad("Managua", "San Salvador", 1),					Ciudad("Managua", "San Domingo", 0),				Ciudad("Managua", "Tegucigalpa", 0),				},
	/*Medellin					*/		{ Ciudad("Medellin", "Belice", 0),				Ciudad("Medellin", "Bogota", 0),				Ciudad("Medellin", "Cali", 0),				Ciudad("Medellin", "Cancún", 0),				Ciudad("Medellin", "Caracas", 0),				Ciudad("Medellin", "Ciudad de Guatemala", 0),				Ciudad("Medellin", "Ciudad de México", 0),				Ciudad("Medellin", "Punta Cana", 0),				Ciudad("Medellin", "Ciudad de Panama", 0),               Ciudad("Medellin", "Flores", 0),				Ciudad("Medellin", "Guayaquil", 0),					Ciudad("Medellin", "La Ceiba", 0),					Ciudad("Medellin", "La Habana", 0),				    Ciudad("Medellin", "Libera", 0),				Ciudad("Medellin", "Lima", 0),				Ciudad("Medellin", "Managua", 0),				Ciudad("Medellin", "Medellin", 0),				Ciudad("Medellin", "Quito", 1),					Ciudad("Medellin", "Roatán", 0),                Ciudad("Medellin", "San José de Costa Rica", 1),                Ciudad("Medellin", "San Juan", 0),					Ciudad("Medellin", "San Pedro de Sula", 0),					Ciudad("Medellin", "San Salvador", 1),					Ciudad("Medellin", "San Domingo", 0),				Ciudad("Medellin", "Tegucigalpa", 0),				},
	/*Punta Cana 				*/		{ Ciudad("Punta Cana", "Belice", 0),			Ciudad("Punta Cana", "Bogota", 1),				Ciudad("Punta Cana", "Cali", 0),			Ciudad("Punta Cana", "Cancún", 0),				Ciudad("Punta Cana", "Caracas", 0),				Ciudad("Punta Cana", "Ciudad de Guatemala", 0),				Ciudad("Punta Cana", "Ciudad de México", 0),			Ciudad("Punta Cana", "Punta Cana", 0),				Ciudad("Punta Cana", "Ciudad de Panama", 0),             Ciudad("Punta Cana", "Flores", 0),				Ciudad("Punta Cana", "Guayaquil", 0),				Ciudad("Punta Cana", "La Ceiba", 0),				Ciudad("Punta Cana", "La Habana", 0),				Ciudad("Punta Cana", "Libera", 0),			    Ciudad("Punta Cana", "Lima", 0),			Ciudad("Punta Cana", "Managua", 0),				Ciudad("Punta Cana", "Medellin", 0),			Ciudad("Punta Cana", "Quito", 0),				Ciudad("Punta Cana", "Roatán", 0),              Ciudad("Punta Cana", "San José de Costa Rica", 0),              Ciudad("Punta Cana", "San Juan", 0),                Ciudad("Punta Cana", "San Pedro de Sula", 0),               Ciudad("Punta Cana", "San Salvador", 0),				Ciudad("Punta Cana", "San Domingo", 0),             Ciudad("Punta Cana", "Tegucigalpa", 0),				},
	/*Quito						*/		{ Ciudad("Quito", "Belice", 0),					Ciudad("Quito", "Bogota", 0),					Ciudad("Quito", "Cali", 0),					Ciudad("Quito", "Cancún", 0),					Ciudad("Quito", "Caracas", 0),					Ciudad("Quito", "Ciudad de Guatemala", 0),					Ciudad("Quito", "Ciudad de México", 0),					Ciudad("Quito", "Punta Cana", 0),					Ciudad("Quito", "Ciudad de Panama", 0),					 Ciudad("Quito", "Flores", 0),					Ciudad("Quito", "Guayaquil", 0),					Ciudad("Quito", "La Ceiba", 0),						Ciudad("Quito", "La Habana", 0),					Ciudad("Quito", "Libera", 0),					Ciudad("Quito", "Lima", 1),					Ciudad("Quito", "Managua", 0),					Ciudad("Quito", "Medellin", 1),					Ciudad("Quito", "Quito", 0),					Ciudad("Quito", "Roatán", 0),					Ciudad("Quito", "San José de Costa Rica", 1),					Ciudad("Quito", "San Juan", 0),						Ciudad("Quito", "San Pedro de Sula", 0),					Ciudad("Quito", "San Salvador", 1),						Ciudad("Quito", "San Domingo", 0),					Ciudad("Quito", "Tegucigalpa", 0),					},
	/*Roatàn					*/		{ Ciudad("Roatán", "Belice", 0),				Ciudad("Roatán", "Bogota", 0),					Ciudad("Roatán", "Cali", 0),				Ciudad("Roatán", "Cancún", 0),					Ciudad("Roatán", "Caracas", 0),					Ciudad("Roatán", "Ciudad de Guatemala", 0),					Ciudad("Roatán", "Ciudad de México", 0),				Ciudad("Roatán", "Punta Cana", 0),					Ciudad("Roatán", "Ciudad de Panama", 0),				 Ciudad("Roatán", "Flores", 0),					Ciudad("Roatán", "Guayaquil", 0),					Ciudad("Roatán", "La Ceiba", 0),					Ciudad("Roatán", "La Habana", 0),					Ciudad("Roatán", "Libera", 0),					Ciudad("Roatán", "Lima", 0),				Ciudad("Roatán", "Managua", 0),					Ciudad("Roatán", "Medellin", 0),				Ciudad("Roatán", "Quito", 0),					Ciudad("Roatán", "Roatán", 0),					Ciudad("Roatán", "San José de Costa Rica", 0),                  Ciudad("Roatán", "San Juan", 0),					Ciudad("Roatán", "San Pedro de Sula", 1),					Ciudad("Roatán", "San Salvador", 1),					Ciudad("Roatán", "San Domingo", 0),					Ciudad("Roatán", "Tegucigalpa", 1),					},
	/*San Josè de Costa Rica	*/		{ Ciudad("San José de Costa Rica", "Belice", 0),Ciudad("San José de Costa Rica", "Bogota", 1),	Ciudad("San José de Costa Rica", "Cali", 0),Ciudad("San José de Costa Rica	", "Cancún", 0),Ciudad("San José de Costa Rica", "Caracas", 1),	Ciudad("San José de Costa Rica", "Ciudad de Guatemala", 1),	Ciudad("San José de Costa Rica", "Ciudad de México", 1),Ciudad("San José de Costa Rica", "Punta Cana", 0),	Ciudad("San José de Costa Rica", "Ciudad de Panama", 1), Ciudad("San José de Costa Rica", "Flores", 0), Ciudad("San José de Costa Rica", "Guayaquil", 0),	Ciudad("San José de Costa Rica", "La Ceiba", 0),    Ciudad("San José de Costa Rica	", "La Habana", 0), Ciudad("San José de Costa Rica", "Libera", 0),  Ciudad("San José de Costa Rica", "Lima", 1),Ciudad("San José de Costa Rica", "Managua", 1), Ciudad("San José de Costa Rica", "Medellin", 1),Ciudad("San José de Costa Rica", "Quito", 1),   Ciudad("San José de Costa Rica", "Roatán", 0),  Ciudad("San José de Costa Rica", "San José de Costa Rica", 0),	Ciudad("San José de Costa Rica", "San Juan", 0),	Ciudad("San José de Costa Rica", "San Pedro de Sula", 1),	Ciudad("San José de Costa Rica", "San Salvador", 1),	Ciudad("San José de Costa Rica", "San Domingo", 1), Ciudad("San José de Costa Rica", "Tegucigalpa", 1), },
	/*San Juan                  */		{ Ciudad("San Juan", "Belice", 0),				Ciudad("San Juan", "Bogota", 1),				Ciudad("San Juan", "Cali", 0),				Ciudad("San Juan", "Cancún", 0),				Ciudad("San Juan", "Caracas", 0),				Ciudad("San Juan", "Ciudad de Guatemala", 0),				Ciudad("San Juan", "Ciudad de México", 0),				Ciudad("San Juan", "Punta Cana", 0),				Ciudad("San Juan", "Ciudad de Panama", 0),               Ciudad("San Juan", "Flores", 0),				Ciudad("San Juan", "Guayaquil", 0),					Ciudad("San Juan", "La Ceiba", 0),					Ciudad("San Juan", "La Habana", 0),					Ciudad("San Juan", "Libera", 0),				Ciudad("San Juan", "Lima", 0),				Ciudad("San Juan", "Managua", 0),				Ciudad("San Juan", "Medellin", 0),				Ciudad("San Juan", "Quito", 0),					Ciudad("San Juan", "Roatán", 0),                Ciudad("San Juan", "San José de Costa Rica", 0),				Ciudad("San Juan", "San Juan", 0),					Ciudad("San Juan", "San Pedro de Sula", 0),					Ciudad("San Juan", "San Salvador", 0),					Ciudad("San Juan", "San Domingo", 0),				Ciudad("San Juan", "Tegucigalpa", 0),				},
	/*San Pedro de Sula         */		{ Ciudad("San Pedro de Sula", "Belice", 0),     Ciudad("San Pedro de Sula", "Bogota", 0),		Ciudad("San Pedro de Sula", "Cali", 0),		Ciudad("San Pedro de Sula", "Cancún", 0),		Ciudad("San Pedro de Sula", "Caracas", 0),		Ciudad("San Pedro de Sula", "Ciudad de Guatemala", 1),		Ciudad("San Pedro de Sula", "Ciudad de México", 0),		Ciudad("San Pedro de Sula", "Punta Cana", 0),		Ciudad("San Pedro de Sula", "Ciudad de Panama", 0),      Ciudad("San Pedro de Sula", "Flores", 0),      Ciudad("San Pedro de Sula", "Guayaquil", 0),        Ciudad("San Pedro de Sula", "La Ceiba", 0),         Ciudad("San Pedro de Sula", "La Habana", 0),        Ciudad("San Pedro de Sula", "Libera", 0),       Ciudad("San Pedro de Sula", "Lima", 0),     Ciudad("San Pedro de Sula", "Managua", 0),      Ciudad("San Pedro de Sula", "Medellin", 0),     Ciudad("San Pedro de Sula", "Quito", 0),		Ciudad("San Pedro de Sula", "Roatán", 1),       Ciudad("San Pedro de Sula", "San José de Costa Rica", 1),       Ciudad("San Pedro de Sula", "San Juan", 0),         Ciudad("San Pedro de Sula", "San Pedro de Sula", 0),        Ciudad("San Pedro de Sula", "San Salvador", 1),         Ciudad("San Pedro de Sula", "San Domingo", 0),      Ciudad("San Pedro de Sula", "Tegucigalpa", 1),		},
...
int matriz2[25][25];
int matrizCuad2[25][25];
int matrizCubi2[25][25];
int matrizEscala1M2[25][25];
int matrizEscala2M2[25][25];
...
void restarMatriz2(int e) {
	for (int i = 0; i < 25; i++) {
		for (int j = 0; j < 25; j++) {
			matrizEscala1M2[i][j] = matrizCuad2[i][j] - matriz2[i][j];
			if (i == j) {
				matrizEscala1M2[i][j] = 0;
			}
			if (matrizEscala1M2[i][j] <= 0) {
				matrizEscala1M2[i][j] = 0;
			}
			if (e == 2) {
				matrizEscala2M2[i][j] = matrizCubi2[i][j] - matrizEscala1M2[i][j];
				matrizEscala2M2[i][j] = matrizEscala2M2[i][j] - matrizCuad2[i][j];
				matrizEscala2M2[i][j] = matrizEscala2M2[i][j] - matriz2[i][j];
				if (i == j) {
					matrizEscala2M2[i][j] = 0;
				}
				if (matrizEscala2M2[i][j] <= 0) {
					matrizEscala2M2[i][j] = 0;
				}
			}
		}
...
void matrizCuadrado2() {
	for (int i = 0; i < 25; i++) {
		for (int j = 0; j < 25; j++) {
			for (int k = 0; k < 25; k++) {
				matrizCuad2[i][j] += matriz2[i][k] * matriz2[k][j];
				if (matrizCuad2[i][j] >= 1) {
					matrizCuad2[i][j] = 1;
				}
			}
		}
...
void matrizCubo2() {
	for (int i = 0; i < 25; i++) {
		for (int j = 0; j < 25; j++) {
			for (int k = 0; k < 25; k++) {
				matrizCubi2[i][j] += matrizCuad2[i][k] * matriz2[k][j];
				if (matrizCubi2[i][j] >= 1) {
					matrizCubi2[i][j] = 1;
				}
			}
		}
...
void escala1M2() {
	...
	for (int i = 0; i < 25; i++) {
		for (int j = 0; j < 25; j++) {
			int v = matrizEscala1M2[i][j];
			string o = getNombre2(i);
			string d = getNombre2(j);
